    ...
    class Program
    {
        ...
        public class MyResource : IDisposable
        {
            ...
            public void Dispose()
            {
                ...
                // Therefore, you sould call GC.SupressFinalize to take this object off the finalization queue
                // and prevent finaliztion code for this object
                // from executing a second time.
                GC.SuppressFinalize(this);
            }

            // Dispose(bool disposing) executes in two distinct scenarios.
            // If disposing equeals true, the method has been called directly
            ...
            ~MyResource()
            {
                ...
                // Callin Dispose(false) is optimal in terms of readability and maintainability.
                Dispose(false);
            }
        }
